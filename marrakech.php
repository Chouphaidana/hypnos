...
<br>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maroc/desert-gc78177b93_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maroc/morocco-g2ff218b3e_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maroc/souk-g92364daaa_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<h1 class="centerTitle">
        <?php echo TXT_PAGES_MARRAKECH_1 ?>
    </h1>
  </div>
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maroc/Maroc - morocco-2809965_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maroc/mosque-g20c6d55ff_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maroc/Maroc - morocco-3881560_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
    <p>
        <?php echo TXT_PAGES_MARRAKECH_2 ?><br>
        <?php echo TXT_PAGES_MARRAKECH_3 ?><br>
        <?php echo TXT_PAGES_MARRAKECH_4 ?><br>
        <?php echo TXT_PAGES_MARRAKECH_5 ?><br>
    </p>
    <br>
    <h4 class="infoPays"><ul>
            <li><?php echo TXT_PAGES_MARRAKECH_6 ?><br></li>
            <li><?php echo TXT_PAGES_MARRAKECH_7 ?><br></li>
            <li><?php echo TXT_PAGES_MARRAKECH_8 ?><br></li>
            <li><?php echo TXT_PAGES_MARRAKECH_9 ?><br></li>
            <li><?php echo TXT_PAGES_MARRAKECH_10 ?></li>
        </ul></h4>
</div>
<br>
<div class="container">
    <h1 class="center">
    <?php echo TXT_PAGES_MARRAKECH_11?>
    </h1>
    <p>
    <?php echo TXT_PAGES_MARRAKECH_12 ?><br>
    <?php echo TXT_PAGES_MARRAKECH_13 ?><br>
    <?php echo TXT_PAGES_MARRAKECH_14 ?><br>
    <?php echo TXT_PAGES_MARRAKECH_15 ?>
    </p>
</div>
<br>
  ...
  <section>    
            <form method="post" action="reservationconfirm.php">
                <div id="reservation">
                    <fieldset>
                        <legend  class="d-block p-2 bg-danger text-white"><?php echo TXT_PAGES_MARRAKECH_1 ?></legend>
                        <p>
