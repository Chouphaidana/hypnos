...
<br>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Bali/Bali - wellness-g22668542f_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Bali/Bali - indonesia-4616370_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Bali/meal-g4950a1c94_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image//Hotel Bali/bali-g1f47d6290_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Bali/meal-g4950a1c94_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
    <p>
        <?php echo TXT_PAGES_BALI_2 ?><br>
        <?php echo TXT_PAGES_BALI_3 ?><br>
        <?php echo TXT_PAGES_BALI_4 ?><br>
    </p>
    <br>
    <h4 class="infoPays"><ul>
            <li><?php echo TXT_PAGES_BALI_5 ?><br></li>
            <li><?php echo TXT_PAGES_BALI_6 ?></li>
            <li><?php echo TXT_PAGES_BALI_7 ?></li>
            <li><?php echo TXT_PAGES_BALI_8 ?></li>
            <li><?php echo TXT_PAGES_BALI_9?></li>
        </ul></h4>
</div>
<br>
<div class="container">
    <h1 class="center">
    <?php echo TXT_PAGES_BALI_10?>
    </h1>
    <p>
    <?php echo TXT_PAGES_BALI_11?><br>
    <?php echo TXT_PAGES_BALI_12?><br>
    <?php echo TXT_PAGES_BALI_13?><br>
    <?php echo TXT_PAGES_BALI_14?>
    </p>
</div>
<br>
                ...
                <div id="reservation">
                    <fieldset>
                        ...
                        <p>
                                ...
                                <input type="radio" name="booking" value="Appartement" id="Appartement" /> <label for="Appartement"><?php echo TXT_RESER_APPT ?></label>
                            </p>
                            <p>
