...
<div class="container">
    <p class="center">
        <?php echo TXT_PAGES_SANTORIN_2 ?><br>
        <?php echo TXT_PAGES_SANTORIN_3 ?><br>
        <?php echo TXT_PAGES_SANTORIN_4 ?><br>
</p>
    <br>
    <h4 class="infoPays"><ul>
            <li><?php echo TXT_PAGES_SANTORIN_5 ?><br></li>
            <li><?php echo TXT_PAGES_SANTORIN_6 ?><br></li>
            <li><?php echo TXT_PAGES_SANTORIN_7 ?><br></li>
            <li><?php echo TXT_PAGES_SANTORIN_8 ?><br></li>
            <li><?php echo TXT_PAGES_SANTORIN_9?></li>
        </ul></h4>
</div>
<br>
<div class="container">
    <h1 class="center">
    <?php echo TXT_PAGES_SANTORIN_10?>
    </h1>
    <p class="center">
    <?php echo TXT_PAGES_SANTORIN_11?><br>
    <?php echo TXT_PAGES_SANTORIN_12?><br>
    <?php echo TXT_PAGES_SANTORIN_13?><br>
</p>
</div>
<br>
...
<section>    
            <form method="post" action="reservationconfirm.php">
                <div id="reservation">
                    <fieldset>
                        <legend  class="d-block p-2 bg-danger text-white"><?php echo TXT_PAGES_SANTORIN_1 ?></legend>
                            <p>
