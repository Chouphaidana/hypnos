...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#dc143c">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Paris/Paris - 213803_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Paris/Paris - 3193674_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Paris/Paris - bistro-498504_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Paris/Paris - building-102840_1280.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image//Hotel Paris/Paris - moulin-rouge-392147_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
    ...
    <p class="container">
        <?php echo TXT_PAGES_PARIS_2 ?><br>
        <?php echo TXT_PAGES_PARIS_3 ?><br>
        <?php echo TXT_PAGES_PARIS_4 ?><br>
    </p>
    <br>
    <h4 class="infoPays"><ul>
            <li><?php echo TXT_PAGES_PARIS_5 ?><br></li>
            <li><?php echo TXT_PAGES_PARIS_6 ?><br></li>
            <li><?php echo TXT_PAGES_PARIS_7 ?><br></li>
            <li><?php echo TXT_PAGES_PARIS_8 ?><br></li>
            <li><?php echo TXT_PAGES_PARIS_9?></li>
        </ul></h4>
</div>
<br>
<div class="container">
    <h1 class="center">
    <?php echo TXT_PAGES_PARIS_10?></h1>
    </h1><br>
    <p class="center">
    <?php echo TXT_PAGES_PARIS_11?><br>
    <?php echo TXT_PAGES_PARIS_12?><br>
    <?php echo TXT_PAGES_PARIS_13?>
    </p>
</div>
<br>
...
<div class="container">
  ...
  <section>    
            <form method="post" action="reservationconfirm.php">
                <div id="reservation">
                    <fieldset>
                        <legend  class="d-block p-2 bg-danger text-white"><?php echo TXT_PAGES_PARIS_1 ?></legend>
                        <p>
                                ...
                                <input type="radio" name="booking" value="Appartement Vue sur la Tour Eiffel" id="Appartement Vue sur la Tour Eiffel" /> <label for="Appartement Vue sur la Tour Eiffel"><?php echo TXT_RESER_APPTVTE ?></label>
                            </p>
                            <p>
