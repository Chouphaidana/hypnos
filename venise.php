...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#dc143c">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Venise/Venice - g4725e9feb_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Venise/Venise - architecture-ga0683f649_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Venise/Venise - houses-gb1b7cb58c_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Venise/Venise - mediterranean-cuisine-g840c2f70b_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Venise/Venise - woman-gd333236a1_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
<br>
    <p class="container  ">
        <?php echo TXT_PAGES_VENISE_2 ?><br>
        <?php echo TXT_PAGES_VENISE_3 ?><br>
        <?php echo TXT_PAGES_VENISE_4 ?><br>
</p>
    <br>
    <h4 class="infoPays"><ul>
            <li><?php echo TXT_PAGES_VENISE_5 ?><br></li>
            <li><?php echo TXT_PAGES_VENISE_6 ?><br></li>
            <li><?php echo TXT_PAGES_VENISE_7 ?><br></li>
            <li><?php echo TXT_PAGES_VENISE_8 ?><br></li>
            <li><?php echo TXT_PAGES_VENISE_9?></li>
        </ul></h4>
</div>
<br>
<div class="container">
    <h1 class="center">
    <?php echo TXT_PAGES_VENISE_10?>
    </h1>
    <p class="center">
    <?php echo TXT_PAGES_VENISE_11?><br>
    <?php echo TXT_PAGES_VENISE_12?><br>
    <?php echo TXT_PAGES_VENISE_12B?><br>
    <?php echo TXT_PAGES_VENISE_13?><br>
    <?php echo TXT_PAGES_VENISE_14?>
</p>
</div>
<br>
  ...
  <section>    
            <form method="post" action="reservationconfirm.php">
                <div id="reservation">
                    <fieldset>
                        <legend  class="d-block p-2 bg-danger text-white"><?php echo TXT_PAGES_VENISE_1 ?></legend>
                        <p>
