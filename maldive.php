...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#dc143c">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maldive/Maldive - beach-g37aa4ab9e_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maldive/Maldive - flower-gb49dfac7e_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maldive/Maldive - flowers-g404713c29_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maldive/Maldive - water-g2b599d044_1920.jpg" alt="beach" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maldive/Maldives - gef6f84abb_1920.jpg" alt="flower" style="width:100%">
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="media/image/Hotel Maldive/Maldives - gc97e2ce28_1920.jpg" alt="flowers" style="width:100%">
      </div>
    </div>
  </div>
</div>
...
<div class="container">
    <p>
        <?php echo TXT_PAGES_MALDIVE_2 ?><br>
        <?php echo TXT_PAGES_MALDIVE_3 ?><br>
        <?php echo TXT_PAGES_MALDIVE_4 ?><br>
    </p>
    <br>
    <h4 class="infoPays"><ul>
            <li><?php echo TXT_PAGES_MALDIVE_5 ?><br></li>
            <li><?php echo TXT_PAGES_MALDIVE_6 ?><br></li>
            <li><?php echo TXT_PAGES_MALDIVE_7 ?><br></li>
            <li><?php echo TXT_PAGES_MALDIVE_8 ?><br></li>
            <li><?php echo TXT_PAGES_MALDIVE_9?></li>
        </ul></h4>
</div>
<br>
<div class="container">
    <h1 class="center">
    <?php echo TXT_PAGES_MALDIVE_10?>
    </h1>
    <p>
    <?php echo TXT_PAGES_MALDIVE_11?><br>
    <?php echo TXT_PAGES_MALDIVE_11B?><br>
    <?php echo TXT_PAGES_MALDIVE_11C?><br>
    <?php echo TXT_PAGES_MALDIVE_12?><br>
    <?php echo TXT_PAGES_MALDIVE_13?><br>
    <?php echo TXT_PAGES_MALDIVE_14?>
    </p>
</div>
<br>
  ...
  <section>    
            <form method="post" action="reservationconfirm.php">
                <div id="reservation">
                    <fieldset>
                        <legend  class="d-block p-2 bg-danger text-white"><?php echo TXT_PAGES_BALI_1 ?></legend>
                        <p>
                                ...
                                <input type="radio" name="booking" value="Chambre sur Piloti" id="Chambre sur Piloti" /> <label for="Chambre sur Piloti"><?php echo TXT_RESER_CHPILOTI ?></label>
                            </p>
                            <p>
                    ...
                    <fieldset>
                        <legend  class="d-block p-2 bg-danger text-white"><?php echo TXT_RESER_4 ?></legend>
                            <p>
                                ...
                                <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Peter" size="150" required />
                            </p>
                            <p>
                                <label for="lastname"><?php echo TXT_RESER_LASTNAME ?></label> <br>
                                <input type="text" class="form-control" name="lastname" id="lastname"placeholder="Pan"  size="150" required />
                            </p>
                            <p>
                                <label for="adress"><?php echo TXT_RESER_ADRESS ?></label> <br>
                                <textarea class="form-control" name="adress" id="adress" placeholder="Montréal" rows="2" cols="150" required ></textarea>
                            </p>
                            <p>
                                <label for="postcode"><?php echo TXT_RESER_POSTCODE ?></label> <br>
                                <input type="text" class="form-control" name="postcode" id="postcode" placeholder="H9X 0B3" size="150" required />
                            </p>
                            <p>
                                <label for="town"><?php echo TXT_RESER_TOWN ?></label> <br>
                                <input type="text" class="form-control" name="town" id="town" placeholder="Canada" size="150" required />
                            </p>
                            <p>
                                <label for="email"><?php echo TXT_RESER_EMAIL ?></label> <br>
                                <input type="email" class="form-control" name="email" id="email" placeholder="contact@hyonos.com" size="150" required />
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <input type="phone" class="form-control" name="phone" id="phone" placeholder="01 02 03 04 05" size="150" required />
                            </p>
                    </fieldset>
                </div>
